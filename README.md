...
Si no eres programador, puedes descargar el ejecutable [aquí](https://github.com/omar49511/add-audio-anki/releases/download/v1.0-beta/DownloadFrasesEnglish.exe), solo sigue los siguientes pasos.
>[!NOTE]
